...
python -m market_maker.db.create_tables -e test --number_of_bots 8

echo
python -m market_maker.db.initial_data_setup_test -e test --number_of_bots 8

echo
echo Creating initial database for NerdMarketMaker application in LIVE environment:
python -m market_maker.db.create_tables -e live --number_of_bots 8

echo
python -m market_maker.db.initial_data_setup_live -e live --number_of_bots 8
